...
export class Initial1684783901703 implements MigrationInterface {
    name = 'Initial1684783901703'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "contact" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" date NOT NULL DEFAULT now(), "name" character varying(60) NOT NULL, "email" character varying(80) NOT NULL, "password" character varying(150) NOT NULL, "number" character varying(11) NOT NULL, "clientId" uuid, CONSTRAINT "UQ_eff09bb429f175523787f46003b" UNIQUE ("email"), CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`);
